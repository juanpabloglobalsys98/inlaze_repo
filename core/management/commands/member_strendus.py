...
class Command(BaseCommand):
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "-c",
            "--campaign",
            default="strendus mex",
            choices=("strendus mex",),
    ...
    def handle(self, *args, **options):
        ...
        try:
            url = (
                ...
                f"&reportmerchantid={strendus_account_id}&reportstartdate={from_date_str}"
        ...
        # "rowid","totalrecords","period","merchantname",
        ...
        # "netrevenueplayer","purchases","netrevenue",
