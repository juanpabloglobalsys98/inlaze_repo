...
class Command(BaseCommand):
    def add_arguments(self, parser):
        ...
        parser.add_argument("-c", "--campaign", default="campeonbet latam",
                            choices=['campeonbet latam'], help='Title of campaign')
    ...
    def handle(self, *args, **options):
        ...
        - currencysymbol : `string`
            ...
            stake operations. expected value `EUR`
        - siteid : `string`
        ...
        - stake:`np.uint32`
            ...
            bets. THIS VALUE ARE NOT SUPPLIED FOR CampeonBet
        ...
        'first_deposit_at': 10,
        """
        logger.info("Making call to API Account CampeonBet")
        ...
        if (campaign_title == "campeonbet latam"):
            campeonbet_key = settings.API_ACCOUNT_REPORT_CAMPEONBETLATAM_KEY
            campeonbet_account_id = settings.API_ACCOUNT_REPORT_CAMPEONBETLATAM_ACCOUNT_ID

        try:
            url = (
                f"https://affiliates.campeonaffiliates.com/api/affreporting.asp?key={campeonbet_key}&"
                f"reportname=AccountReport&reportformat=csv&reportmerchantid={campeonbet_account_id}&"
        ...
        # "registrationdate","firstdeposit","Deposits","Bonus","Grossrevenue",
        # "Netrevenue","%Commission","CPACommission","cpacommissioncount",
        # "totalcommission","new"
