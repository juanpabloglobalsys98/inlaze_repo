...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        - firstdepositcount : `np.uint32`
            ...
            first_deposit_count. This value is not supplied by GanaBet 
            for Merchant Ganabet
        ...
        try:
            url = (
                ...
                f"&reportmerchantid={ganabet_account_id}&reportstartdate={from_date_str}"
    ...
    def betenlace_daily_update(
        ...
        # First deposit count not supplied by Ganabet
