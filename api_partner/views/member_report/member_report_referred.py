...
class MemberReportFromPartnerReferredAPI(APIView, GetAllmemberReport):
    """
    ...
    def get(self, request):
        ...
        filters = [
            Q(referred_by_id=request.user.id)
        ]
        ...
        if (validator.document.get('group_by_month') or validator.document.get('group_by_campaign')):
            ...
            annotate_filters = {
                **fx_conversion_cases,
                ...
                "fixed_income_referred_local": Sum("fixed_income_referred_local"),
                "net_revenue_referred_local": Sum("net_revenue_referred_local")
            }
            ...
            member_ser = MemberReportGroupedReferredSer(
                instance=member_pag,
                many=True,
            )
