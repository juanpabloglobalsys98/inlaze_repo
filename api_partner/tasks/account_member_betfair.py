...
def account_member_betfair(
    campaign_title,
    update_account=True,
    update_cpa=True,
):
    """
    Get data from API of bookmaker Betfair with data in JSON format
    ...
    if (campaign_title == "betfair col"):
        api_key = settings.API_ACC_MEM_REPORT_BETFAIR_COL_KEY
        revenue_share_percentage = settings.API_ACC_MEM_REPORT_BETFAIR_COL_RS_PERCENTAGE
    elif (campaign_title == "betfair col 2"):
        api_key = settings.API_ACC_MEM_REPORT_BETFAIR_COL_2_KEY
        revenue_share_percentage = settings.API_ACC_MEM_REPORT_BETFAIR_COL_2_RS_PERCENTAGE
    elif (campaign_title == "betfair col 3"):
        api_key = settings.API_ACC_MEM_REPORT_BETFAIR_COL_3_KEY
        revenue_share_percentage = settings.API_ACC_MEM_REPORT_BETFAIR_COL_3_RS_PERCENTAGE
    elif (campaign_title == "betfair col 4"):
        api_key = settings.API_ACC_MEM_REPORT_BETFAIR_COL_4_KEY
        revenue_share_percentage = settings.API_ACC_MEM_REPORT_BETFAIR_COL_4_RS_PERCENTAGE
    elif (campaign_title == "betfair latam"):
        api_key = settings.API_ACC_MEM_REPORT_BETFAIR_LATAM_KEY
        revenue_share_percentage = settings.API_ACC_MEM_REPORT_BETFAIR_LATAM_RS_PERCENTAGE
    elif (campaign_title == "betfair br"):
        api_key = settings.API_ACC_MEM_REPORT_BETFAIR_BR_KEY
        revenue_share_percentage = settings.API_ACC_MEM_REPORT_BETFAIR_BR_RS_PERCENTAGE
    elif (campaign_title == "betfair pe"):
        api_key = settings.API_ACC_MEM_REPORT_BETFAIR_PE_KEY
        revenue_share_percentage = settings.API_ACC_MEM_REPORT_BETFAIR_PE_RS_PERCENTAGE
    elif (campaign_title == "betfair mex"):
        api_key = settings.API_ACC_MEM_REPORT_BETFAIR_MEX_KEY
        revenue_share_percentage = settings.API_ACC_MEM_REPORT_BETFAIR_MEX_RS_PERCENTAGE
    elif (campaign_title == "betfair esp"):
        api_key = settings.API_ACC_MEM_REPORT_BETFAIR_ESP_KEY
        revenue_share_percentage = settings.API_ACC_MEM_REPORT_BETFAIR_ESP_RS_PERCENTAGE
    else:
        error_msg = f"Campaign with title {campaign_title} not defined on account member betfair"
        logger_task.error(error_msg)
        return
    ...
    # Punters by activity
    url = (
        "https://betfair.dataexport.netrefer.com/v2/export/reports/affiliate/XML_CustomerReporting_InclSubAff?"
    ...
    url = (
        "https://betfair.dataexport.netrefer.com/v2/export/reports/affiliate/XML_MS_DailyFigures_InclSubAff?"
