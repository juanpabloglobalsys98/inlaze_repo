...
def member_betano(campaign_title):
    """
    Get data from API of bookmaker Betano with CSV files using 
    ...
    try:
        url = (
            ...
            f"&reportmerchantid={betano_account_id}&reportstartdate={yesterday_str}"
