...
def account_campeonbet(campaign_title):
    """
    ...
    try:
        url = (
            "https://affiliates.campeonaffiliates.com/api/affreporting.asp?"
            f"key={campeonbet_key}&reportname=AccountReport&"
            f"reportformat=csv&reportmerchantid={campeonbet_account_id}"
