...
def member_campeonbet(campaign_title):
    """
    Get data from API of bookmaker Betenlace with CSV files using 
    ...
    try:
        url = (
            ...
            f"&reportmerchantid={campeonbet_account_id}&reportstartdate={yesterday_str}"
