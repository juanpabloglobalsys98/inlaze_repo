...
class AccMemYajuegoUploadKeyAPI(APIView):
    """
    ...
    def post(self, request):
        ...
        campaign_api_key = validator.document.get("key")
        # Get Campaign by its API key
        query = Q(api_key=campaign_api_key)
        ...
        if not campaign or campaign.campaign_title.lower() != "yajuego 50":
            error_msg = f"Campaign with API key \"{campaign_api_key}\" not found in DB"
        ...
        logger_msg = (
            "AccMemYajuegoUploadKeyAPI called\n"
